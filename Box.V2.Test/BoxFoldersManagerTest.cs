    ...
    public class BoxFoldersManagerTest : BoxResourceManagerTest
    {
        ...
        public async Task UpdateFolderInformation_ValidResponse_ValidFolder()
        {
            ...
            BoxFolderRequest folderReq = new BoxFolderRequest()
            {
                ...
                FolderUploadEmail = new BoxEmailRequest() { Access = BoxEmailRequestAccessType.open },
                Description = "folder description",
                Parent = new BoxRequestEntity() { Id = "parentId", Type = BoxType.folder },
                OwnedBy = new BoxRequestEntity() { Id = "userId" },
                SharedLink = new BoxSharedLinkRequest()
                {
                    UnsharedAt = new DateTime(2016, 9, 6),
                    Permissions = new BoxPermissionsRequest() { Download = true, Preview = false }
                },
            ...
            Assert.AreEqual(_FoldersUri + "fakeId", boxRequest.AbsoluteUri.AbsoluteUri);
            Assert.IsTrue(AreJsonStringsEqual(
                "{\"folder_upload_email\":{\"access\":\"open\"},\"owned_by\":{\"id\":\"userId\"},\"sync_state\":\"not_synced\",\"parent\":{\"id\":\"parentId\",\"type\":\"folder\"},\"name\":\"New Folder Name!\",\"description\":\"folder description\",\"shared_link\":{\"access\":null,\"unshared_at\":\"2016-09-06T00:00:00+02:00\",\"permissions\":{\"can_download\":true,\"can_preview\":false}},\"tags\":[\"tag1\",\"tag2\",\"tag3\"]}",
                boxRequest.Payload));
