    ...
    public class BoxFilesManagerTest : BoxResourceManagerTest
    {
        ...
        public async Task UpdateFileInformation_ValidResponse_ValidFile()
        {
            ...
            BoxFileRequest request = new BoxFileRequest()
            {
                ...
                Parent = new BoxRequestEntity() { Id = "newparentId" },
                SharedLink = new BoxSharedLinkRequest()
                {
                    Access = BoxSharedLinkAccessType.company,
                    UnsharedAt = new DateTime(2016, 8, 25),
                    Permissions = new BoxPermissionsRequest() { Download = false, Preview = true }
                },
                Tags = new string[2] { "tag1", "tag2" }
            };

            BoxFile f = await _filesManager.UpdateInformationAsync("fakeId", request);
            ...
            Assert.IsTrue(AreJsonStringsEqual(
                "{\"parent\":{\"id\":\"newparentId\"},\"name\":\"newName\",\"description\":\"newDescription\",\"shared_link\":{\"access\":\"company\",\"unshared_at\":\"2016-08-25T00:00:00+02:00\",\"permissions\":{\"can_download\":false,\"can_preview\":true}},\"tags\":[\"tag1\",\"tag2\"]}", 
                boxRequest.Payload));
        ...
        public async Task CopyFile_ValidResponse_ValidFile()
        {
            ...
            /*** Act ***/
            BoxFile f = await _filesManager.CopyAsync("5000948880", "0", "test");
        ...
        public async Task CreateFileSharedLink_ValidResponse_ValidFile()
        {
            ...
            Assert.IsNotNull(boxRequest);
            Assert.AreEqual(RequestMethod.Put, boxRequest.Method);
            Assert.AreEqual(_FilesUri + "0", boxRequest.AbsoluteUri.AbsoluteUri);
            Assert.IsTrue(AreJsonStringsEqual("{\"shared_link\":{\"access\":\"collaborators\",\"permissions\":{\"can_download\":true,\"can_preview\":false},\"password\":\"somepwd\"}}",
                boxRequest.Payload));
        ...
        public async Task PreflightCheck_ValidResponse_ValidStatus()
        {
            ...
            /*** Act ***/
            bool result = await _filesManager.PreflightCheck(new BoxPreflightCheckRequest()
                {
