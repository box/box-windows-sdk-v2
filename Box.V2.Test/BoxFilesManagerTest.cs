...
namespace Box.V2.Test
{
    ...
    public class BoxFilesManagerTest : BoxResourceManagerTest
    {
        ...
        public async Task DownloadZip_ValidResponse()
        {
            string fileLocation;
#if NET45
            fileLocation = "../.././Debug/net45/TestData/smalltest.pdf";
#elif NETCOREAPP2_0
            fileLocation = "../.././Debug/netcoreapp2.0/TestData/smalltest.pdf";
#endif
            using (FileStream exampleFile = new FileStream(string.Format(fileLocation), FileMode.OpenOrCreate))
            {
                /*** Arrange ***/
