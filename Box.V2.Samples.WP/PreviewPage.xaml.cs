...
namespace Box.V2.WP
{
    public partial class PreviewPage : PhoneApplicationPage
    {
        ...
        private const string fileNameFormat = "Preview/{0}-{1}{2}";
        private const string addPreviewContainers = "addPreviewContainers";
        private const string addPreview = "addPreview";
        ...
        private async Task Init()
        {
            ...
            previewBrowser.Navigate(new Uri("/Preview/preview.html", UriKind.Relative));
        }
        ...
        private void SaveFilesToIsoStore()
        {
            ...
            string[] files = {
            "Preview/preview.html", "Preview/jquery-1.10.1.min.js", "Preview/waypoints.min.js"
        };
        ...
        {
            await GetNextPages(_main.SelectedItem.Id, pagesLoaded, buffer);
            pagesLoaded += buffer;
        }
        ...
        private void previewBrowser_ScriptNotify(object sender, NotifyEventArgs e)
        {
