...
namespace Box.V2.Config
{
    public static class Constants
    {
        ...
        public const string BoxApiV2Version = @"v2";
        public const string BoxApiCurrentVersion = BoxApiV2Version;
        ...
        public const string BoxAuthAuthorizeApiUriString = "https://account.box.com/api/oauth2/authorize";
