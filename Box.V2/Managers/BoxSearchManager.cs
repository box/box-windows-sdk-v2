...
namespace Box.V2.Managers
{
    ...
    public class BoxSearchManager : BoxResourceManager
    {
        ...
        /// <param name="fileExtensions">Limit searches to specific file extensions like pdf,png, or doc. The value can be a single file extension or a comma-delimited list of extensions. For example: png,md,pdf</param>
