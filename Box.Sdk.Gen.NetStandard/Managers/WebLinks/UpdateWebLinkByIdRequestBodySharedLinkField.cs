...
namespace Box.Sdk.Gen.Managers {
    public class UpdateWebLinkByIdRequestBodySharedLinkField : ISerializable {
        [JsonInclude]
        ...
        public StringEnum<UpdateWebLinkByIdRequestBodySharedLinkAccessField> Access { get; set; }
