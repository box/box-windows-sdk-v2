...
namespace Box.Sdk.Gen.Managers {
    public class SearchManager {
        ...
        /// </param>
        public async System.Threading.Tasks.Task<MetadataQueryResults> SearchByMetadataQueryAsync(MetadataQuery requestBody, SearchByMetadataQueryHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task<SearchResultsResponse> SearchForContentAsync(SearchForContentQueryParams queryParams = default, SearchForContentHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
            ...
            return SimpleJsonSerializer.DeserializeWithoutRawJson<SearchResultsResponse>(NullableUtils.Unwrap(response.Data));
        }
