...
namespace Box.Sdk.Gen.Schemas {
    public class UploadSession : ISerializable {
        ...
        public StringEnum<UploadSessionTypeField> Type { get; set; }

        /// <summary>
        /// The date and time when this session expires.
        /// </summary>
        [JsonPropertyName("session_expires_at")]
        public System.DateTimeOffset? SessionExpiresAt { get; set; }
        ...
        public UploadSessionSessionEndpointsField SessionEndpoints { get; set; }
