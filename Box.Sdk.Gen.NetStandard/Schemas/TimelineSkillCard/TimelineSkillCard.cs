...
namespace Box.Sdk.Gen.Schemas {
    public class TimelineSkillCard : ISerializable {
        ...
        public StringEnum<TimelineSkillCardTypeField> Type { get; set; }
        ...
        public StringEnum<TimelineSkillCardSkillCardTypeField> SkillCardType { get; set; }

        /// <summary>
        /// The title of the card.
        /// </summary>
        [JsonPropertyName("skill_card_title")]
        public TimelineSkillCardSkillCardTitleField SkillCardTitle { get; set; }
