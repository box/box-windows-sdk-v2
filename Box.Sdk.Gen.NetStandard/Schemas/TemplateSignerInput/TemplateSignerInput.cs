...
namespace Box.Sdk.Gen.Schemas {
    public class TemplateSignerInput : SignRequestPrefillTag, ISerializable {
        ...
        public StringEnum<TemplateSignerInputTypeField> Type { get; set; }
        ...
        public StringEnum<TemplateSignerInputContentTypeField> ContentType { get; set; }
        ...
        public string DocumentId { get => _documentId; set { _documentId = value; _isDocumentIdSet = true; } }
        ...
        public IReadOnlyList<string> DropdownChoices { get => _dropdownChoices; set { _dropdownChoices = value; _isDropdownChoicesSet = true; } }
        ...
        public string GroupId { get => _groupId; set { _groupId = value; _isGroupIdSet = true; } }

        /// <summary>
        /// Where the input is located on a page.
        /// </summary>
        [JsonPropertyName("coordinates")]
        public TemplateSignerInputCoordinatesField Coordinates { get; set; }

        /// <summary>
        /// The size of the input.
        /// </summary>
        [JsonPropertyName("dimensions")]
        public TemplateSignerInputDimensionsField Dimensions { get; set; }
