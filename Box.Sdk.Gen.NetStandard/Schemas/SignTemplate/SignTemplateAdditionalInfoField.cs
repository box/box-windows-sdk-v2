...
namespace Box.Sdk.Gen.Schemas {
    public class SignTemplateAdditionalInfoField : ISerializable {
        ...
        public IReadOnlyList<StringEnum<SignTemplateAdditionalInfoNonEditableField>> NonEditable { get; set; }

        /// <summary>
        /// Required fields.
        /// </summary>
        [JsonPropertyName("required")]
        public SignTemplateAdditionalInfoRequiredField Required { get; set; }
