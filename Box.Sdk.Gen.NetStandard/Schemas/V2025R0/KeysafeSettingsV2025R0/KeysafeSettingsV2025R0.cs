...
namespace Box.Sdk.Gen.Schemas {
    public class KeysafeSettingsV2025R0 : ISerializable {
        ...
        public bool? KeysafeEnabled { get; set; }

        /// <summary>
        /// The cloud provider.
        /// </summary>
        [JsonPropertyName("cloud_provider")]
        public string CloudProvider { get => _cloudProvider; set { _cloudProvider = value; _isCloudProviderSet = true; } }

        /// <summary>
        /// The key ID.
        /// </summary>
        [JsonPropertyName("key_id")]
        public string KeyId { get => _keyId; set { _keyId = value; _isKeyIdSet = true; } }

        /// <summary>
        /// The account ID.
        /// </summary>
        [JsonPropertyName("account_id")]
        public string AccountId { get => _accountId; set { _accountId = value; _isAccountIdSet = true; } }

        /// <summary>
        /// The location ID.
        /// </summary>
        [JsonPropertyName("location_id")]
        public string LocationId { get => _locationId; set { _locationId = value; _isLocationIdSet = true; } }

        /// <summary>
        /// The project ID.
        /// </summary>
        [JsonPropertyName("project_id")]
        public string ProjectId { get => _projectId; set { _projectId = value; _isProjectIdSet = true; } }

        /// <summary>
        /// The key ring ID.
        /// </summary>
        [JsonPropertyName("keyring_id")]
        public string KeyringId { get => _keyringId; set { _keyringId = value; _isKeyringIdSet = true; } }
