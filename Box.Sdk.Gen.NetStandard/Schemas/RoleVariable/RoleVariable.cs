...
namespace Box.Sdk.Gen.Schemas {
    public class RoleVariable : ISerializable {
        ...
        public StringEnum<RoleVariableTypeField> Type { get; set; }
        ...
        public StringEnum<RoleVariableVariableTypeField> VariableType { get; set; }

        [JsonPropertyName("variable_value")]
        [JsonConverter(typeof(StringEnumConverter<RoleVariableVariableValueField>))]
        public StringEnum<RoleVariableVariableValueField> VariableValue { get; set; }
