...
namespace Box.V2.Samples.JWTAuth
{
    class Program
    {
        ...
        static readonly string DEVELOPER_TOKEN = "EPkHIyh6uLenusGzJlm9mlaTkzZTMsaO";
        ...
        static void Main(string[] args)
        {
            ...
            var adminToken = BoxJWTAuth.EnterpriseToken(ENTERPRISE_ID, CLIENT_ID, CLIENT_SECRET, privateKey, JWT_PRIVATE_KEY_PASSWORD, publicKeyId: publicKeyId);
