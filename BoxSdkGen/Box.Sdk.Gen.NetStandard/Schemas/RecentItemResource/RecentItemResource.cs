...
namespace Box.Sdk.Gen.Schemas {
    ...
    public class RecentItemResource {
        ...
        public static implicit operator RecentItemResource(FolderFull value) => new RecentItemResource(value);
        
        public static implicit operator RecentItemResource(WebLink value) => new RecentItemResource(value);
        
        class RecentItemResourceConverter : JsonConverter<RecentItemResource> {
            public override RecentItemResource Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) {
            ...
            public override void Write(Utf8JsonWriter writer, RecentItemResource value, JsonSerializerOptions options) {
