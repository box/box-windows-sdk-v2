...
namespace Box.Sdk.Gen.Schemas {
    public class FileFullRepresentationsEntriesField : ISerializable {
        ...
        public FileFullRepresentationsEntriesContentField Content { get; set; }
        ...
        public FileFullRepresentationsEntriesInfoField Info { get; set; }

        /// <summary>
        /// An object containing the size and type of this presentation.
        /// </summary>
        [JsonPropertyName("properties")]
        public FileFullRepresentationsEntriesPropertiesField Properties { get; set; }
        ...
        public FileFullRepresentationsEntriesStatusField Status { get; set; }
