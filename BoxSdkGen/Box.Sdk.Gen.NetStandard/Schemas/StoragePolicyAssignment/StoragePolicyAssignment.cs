...
namespace Box.Sdk.Gen.Schemas {
    public class StoragePolicyAssignment : ISerializable {
        ...
        public StringEnum<StoragePolicyAssignmentTypeField> Type { get; set; }

        [JsonPropertyName("storage_policy")]
        public StoragePolicyMini StoragePolicy { get; set; }

        [JsonPropertyName("assigned_to")]
        public StoragePolicyAssignmentAssignedToField AssignedTo { get; set; }
