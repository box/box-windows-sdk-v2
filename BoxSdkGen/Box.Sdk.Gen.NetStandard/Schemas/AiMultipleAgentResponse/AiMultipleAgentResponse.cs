...
namespace Box.Sdk.Gen.Schemas {
    public class AiMultipleAgentResponse : ISerializable {
        [JsonInclude]
        ...
        public IReadOnlyList<AiSingleAgentResponseFull> Entries { get; set; }

        public AiMultipleAgentResponse(IReadOnlyList<AiSingleAgentResponseFull> entries) {
            Entries = entries;
        }
