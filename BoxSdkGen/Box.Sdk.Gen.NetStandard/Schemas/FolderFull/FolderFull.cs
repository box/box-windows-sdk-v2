...
namespace Box.Sdk.Gen.Schemas {
    public class FolderFull : Folder, ISerializable {
        ...
        public StringEnum<FolderFullSyncStateField> SyncState { get; set; }
        ...
        public FolderFullPermissionsField Permissions { get; set; }
        ...
        public FolderFullMetadataField Metadata { get; set; }
        ...
        public IReadOnlyList<StringEnum<FolderFullAllowedSharedLinkAccessLevelsField>> AllowedSharedLinkAccessLevels { get; set; }
        ...
        public IReadOnlyList<StringEnum<FolderFullAllowedInviteeRolesField>> AllowedInviteeRoles { get; set; }

        [JsonPropertyName("watermark_info")]
        public FolderFullWatermarkInfoField WatermarkInfo { get; set; }
        ...
        public FolderFullClassificationField Classification { get; set; }
