...
namespace Box.Sdk.Gen.Schemas {
    public class StatusSkillCard : ISerializable {
        ...
        public StringEnum<StatusSkillCardTypeField> Type { get; set; }
        ...
        public StringEnum<StatusSkillCardSkillCardTypeField> SkillCardType { get; set; }

        /// <summary>
        /// The title of the card.
        /// </summary>
        [JsonPropertyName("skill_card_title")]
        public StatusSkillCardSkillCardTitleField SkillCardTitle { get; set; }
