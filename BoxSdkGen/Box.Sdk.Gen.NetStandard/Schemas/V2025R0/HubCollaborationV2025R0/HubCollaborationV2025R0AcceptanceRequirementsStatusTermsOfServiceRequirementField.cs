...
namespace Box.Sdk.Gen.Schemas {
    public class HubCollaborationV2025R0AcceptanceRequirementsStatusTermsOfServiceRequirementField : ISerializable {
        [JsonInclude]
        ...
        public bool? IsAccepted { get => _isAccepted; set { _isAccepted = value; _isIsAcceptedSet = true; } }

        [JsonPropertyName("terms_of_service")]
        public TermsOfServiceBaseV2025R0 TermsOfService { get; set; }
