...
namespace Box.Sdk.Gen.Schemas {
    public class CollaborationAllowlistEntry : ISerializable {
        ...
        public StringEnum<CollaborationAllowlistEntryTypeField> Type { get; set; }
        ...
        public StringEnum<CollaborationAllowlistEntryDirectionField> Direction { get; set; }

        [JsonPropertyName("enterprise")]
        public CollaborationAllowlistEntryEnterpriseField Enterprise { get; set; }
