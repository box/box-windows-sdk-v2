...
namespace Box.Sdk.Gen.Schemas {
    public class SignRequestSignerSignerDecisionField : ISerializable {
        ...
        public StringEnum<SignRequestSignerSignerDecisionTypeField> Type { get; set; }
        ...
        public string AdditionalInfo { get => _additionalInfo; set { _additionalInfo = value; _isAdditionalInfoSet = true; } }
