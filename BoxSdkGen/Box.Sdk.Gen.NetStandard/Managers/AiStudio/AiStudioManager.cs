...
namespace Box.Sdk.Gen.Managers {
    public class AiStudioManager {
        ...
        /// </param>
        public async System.Threading.Tasks.Task<AiMultipleAgentResponse> GetAiAgentsAsync(GetAiAgentsQueryParams queryParams = default, GetAiAgentsHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task<AiSingleAgentResponseFull> CreateAiAgentAsync(CreateAiAgent requestBody, CreateAiAgentHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task<AiSingleAgentResponseFull> UpdateAiAgentByIdAsync(string agentId, CreateAiAgent requestBody, UpdateAiAgentByIdHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
            headers = headers ?? new UpdateAiAgentByIdHeaders();
            Dictionary<string, string> headersMap = Utils.PrepareParams(map: DictionaryUtils.MergeDictionaries(new Dictionary<string, string>() {  }, headers.ExtraHeaders));
            FetchResponse response = await this.NetworkSession.NetworkClient.FetchAsync(options: new FetchOptions(url: string.Concat(this.NetworkSession.BaseUrls.BaseUrl, "/2.0/ai_agents/", NullableUtils.Unwrap(StringUtils.ToStringRepresentation(agentId))), method: "PUT", contentType: "application/json", responseFormat: Box.Sdk.Gen.ResponseFormat.Json) { Headers = headersMap, Data = SimpleJsonSerializer.Serialize(requestBody), Auth = this.Auth, NetworkSession = this.NetworkSession, CancellationToken = cancellationToken }).ConfigureAwait(false);
            return SimpleJsonSerializer.Deserialize<AiSingleAgentResponseFull>(NullableUtils.Unwrap(response.Data));
        }
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task<AiSingleAgentResponseFull> GetAiAgentByIdAsync(string agentId, GetAiAgentByIdQueryParams queryParams = default, GetAiAgentByIdHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task DeleteAiAgentByIdAsync(string agentId, DeleteAiAgentByIdHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
