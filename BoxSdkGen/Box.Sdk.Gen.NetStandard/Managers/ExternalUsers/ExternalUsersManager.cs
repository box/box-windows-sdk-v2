...
namespace Box.Sdk.Gen.Managers {
    public class ExternalUsersManager {
        ...
        /// </param>
        public async System.Threading.Tasks.Task<ExternalUsersSubmitDeleteJobResponseV2025R0> SubmitJobToDeleteExternalUsersV2025R0Async(ExternalUsersSubmitDeleteJobRequestV2025R0 requestBody, SubmitJobToDeleteExternalUsersV2025R0Headers headers = default, System.Threading.CancellationToken cancellationToken = default) {
            headers = headers ?? new SubmitJobToDeleteExternalUsersV2025R0Headers();
