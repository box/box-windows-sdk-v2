...
namespace Box.Sdk.Gen.Internal
{
    ...
    public static class Utils
    {
        ...
        public static string DateTimeToString(DateTimeOffset dateTime)
        {
            ...
            return dateTime.Offset == TimeSpan.Zero ? dateTimeAsString.Substring(0, dateTimeAsString.Length - 6) + "Z" : dateTimeAsString;
        }

        /// <summary>
        /// Converts string in ISO 8601 format to DateTimeOffset. DateOnly is not supported in .NET Standard.
        /// </summary>
        /// <param name="dateTime">Input string (ISO 8601)</param>
        /// <returns>DateTimeOffset</returns>
        public static DateTimeOffset DateFromString(string date) => DateTimeOffset.Parse(date);

        /// <summary>
        /// Converts DateTimeOffset to string in ISO 8601 format. DateOnly is not supported in .NET Standard.
        /// </summary>
        /// <param name="date">Input DateTimeOffset</param>
        /// <returns>String (ISO 8601)</returns>
        public static string DateToString(DateTimeOffset date) => date.Date.ToString("yyyy-MM-dd");
