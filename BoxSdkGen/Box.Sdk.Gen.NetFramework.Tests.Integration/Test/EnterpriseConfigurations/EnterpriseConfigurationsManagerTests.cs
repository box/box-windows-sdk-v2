...
namespace Box.Sdk.Gen.Tests.Integration {
    ...
    public class EnterpriseConfigurationsManagerTests {
        ...
        public async System.Threading.Tasks.Task TestGetEnterpriseConfigurationById() {
            ...
            EnterpriseConfigurationUserSettingsV2025R0 userSettings = NullableUtils.Unwrap(enterpriseConfiguration.UserSettings);
            ...
            EnterpriseConfigurationContentAndSharingV2025R0 contentAndSharing = NullableUtils.Unwrap(enterpriseConfiguration.ContentAndSharing);
            ...
            EnterpriseConfigurationSecurityV2025R0 security = NullableUtils.Unwrap(enterpriseConfiguration.Security);
            Assert.IsTrue(NullableUtils.Unwrap(NullableUtils.Unwrap(security.IsManagedUserSignupEnabled).Value) == false);
            EnterpriseConfigurationShieldV2025R0 shield = NullableUtils.Unwrap(enterpriseConfiguration.Shield);
