...
namespace Box.Sdk.Gen.Tests.Integration {
    ...
    public class ShieldListsManagerTests {
        ...
        public async System.Threading.Tasks.Task TestCreateGetUpdateDeleteShieldList() {
            ...
            ShieldListV2025R0 shieldListContentEmail = await client.ShieldLists.CreateShieldListV2025R0Async(requestBody: new ShieldListsCreateV2025R0(name: shieldListContentEmailName, content: new ShieldListContentEmailV2025R0(type: ShieldListContentEmailV2025R0TypeField.Email, emailAddresses: Array.AsReadOnly(new [] {"test@boxdemo.com","test@example.com"}))) { Description = "A list of things that are shielded" });
