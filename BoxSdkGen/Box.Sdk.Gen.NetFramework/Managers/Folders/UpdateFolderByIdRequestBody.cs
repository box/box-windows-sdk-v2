...
namespace Box.Sdk.Gen.Managers {
    public class UpdateFolderByIdRequestBody : ISerializable {
        ...
        public StringEnum<UpdateFolderByIdRequestBodySyncStateField> SyncState { get; set; }
        ...
        public UpdateFolderByIdRequestBodyParentField Parent { get; set; }

        [JsonPropertyName("shared_link")]
        public UpdateFolderByIdRequestBodySharedLinkField SharedLink { get; set; }

        [JsonPropertyName("folder_upload_email")]
        public UpdateFolderByIdRequestBodyFolderUploadEmailField FolderUploadEmail { get => _folderUploadEmail; set { _folderUploadEmail = value; _isFolderUploadEmailSet = true; } }
