...
namespace Box.Sdk.Gen.Schemas {
    public class RetentionPolicyAssignment : ISerializable {
        ...
        public StringEnum<RetentionPolicyAssignmentTypeField> Type { get; set; }

        [JsonPropertyName("retention_policy")]
        public RetentionPolicyMini RetentionPolicy { get; set; }
        ...
        public RetentionPolicyAssignmentAssignedToField AssignedTo { get; set; }
        ...
        public IReadOnlyList<RetentionPolicyAssignmentFilterFieldsField> FilterFields { get => _filterFields; set { _filterFields = value; _isFilterFieldsSet = true; } }
