...
namespace Box.Sdk.Gen.Schemas {
    public class TermsOfService : TermsOfServiceBase, ISerializable {
        ...
        public StringEnum<TermsOfServiceStatusField> Status { get; set; }

        [JsonPropertyName("enterprise")]
        public TermsOfServiceEnterpriseField Enterprise { get; set; }
        ...
        public StringEnum<TermsOfServiceTosTypeField> TosType { get; set; }
