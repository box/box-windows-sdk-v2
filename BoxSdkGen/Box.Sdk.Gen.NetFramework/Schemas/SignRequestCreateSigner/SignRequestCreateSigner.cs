...
namespace Box.Sdk.Gen.Schemas {
    public class SignRequestCreateSigner : ISerializable {
        ...
        public StringEnum<SignRequestCreateSignerRoleField> Role { get; set; }
        ...
        public string EmbedUrlExternalUserId { get => _embedUrlExternalUserId; set { _embedUrlExternalUserId = value; _isEmbedUrlExternalUserIdSet = true; } }
        ...
        public bool? LoginRequired { get => _loginRequired; set { _loginRequired = value; _isLoginRequiredSet = true; } }
        ...
        public string VerificationPhoneNumber { get => _verificationPhoneNumber; set { _verificationPhoneNumber = value; _isVerificationPhoneNumberSet = true; } }
        ...
        public string Password { get => _password; set { _password = value; _isPasswordSet = true; } }
        ...
        public string SignerGroupId { get => _signerGroupId; set { _signerGroupId = value; _isSignerGroupIdSet = true; } }

        /// <summary>
        /// If true, no emails about the sign request will be sent.
        /// </summary>
        [JsonPropertyName("suppress_notifications")]
        public bool? SuppressNotifications { get => _suppressNotifications; set { _suppressNotifications = value; _isSuppressNotificationsSet = true; } }
        ...
        public string Language { get => _language; set { _language = value; _isLanguageSet = true; } }
