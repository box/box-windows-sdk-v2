...
namespace Box.Sdk.Gen.Schemas {
    public class IntegrationMappingPartnerItemSlack : ISerializable {
        ...
        public StringEnum<IntegrationMappingPartnerItemSlackTypeField> Type { get; set; }
        ...
        public string SlackWorkspaceId { get => _slackWorkspaceId; set { _slackWorkspaceId = value; _isSlackWorkspaceIdSet = true; } }
        ...
        public string SlackOrgId { get => _slackOrgId; set { _slackOrgId = value; _isSlackOrgIdSet = true; } }
