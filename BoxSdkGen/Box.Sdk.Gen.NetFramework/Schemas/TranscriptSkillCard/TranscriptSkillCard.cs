...
namespace Box.Sdk.Gen.Schemas {
    public class TranscriptSkillCard : ISerializable {
        ...
        public StringEnum<TranscriptSkillCardTypeField> Type { get; set; }
        ...
        public StringEnum<TranscriptSkillCardSkillCardTypeField> SkillCardType { get; set; }

        /// <summary>
        /// The title of the card.
        /// </summary>
        [JsonPropertyName("skill_card_title")]
        public TranscriptSkillCardSkillCardTitleField SkillCardTitle { get; set; }
