...
namespace Box.Sdk.Gen.Schemas {
    public class KeywordSkillCard : ISerializable {
        ...
        public StringEnum<KeywordSkillCardTypeField> Type { get; set; }
        ...
        public StringEnum<KeywordSkillCardSkillCardTypeField> SkillCardType { get; set; }

        /// <summary>
        /// The title of the card.
        /// </summary>
        [JsonPropertyName("skill_card_title")]
        public KeywordSkillCardSkillCardTitleField SkillCardTitle { get; set; }
