...
namespace Box.Sdk.Gen.Schemas {
    public class FileFullLockField : ISerializable {
        ...
        public StringEnum<FileFullLockTypeField> Type { get; set; }
        ...
        public StringEnum<FileFullLockAppTypeField> AppType { get => _appType; set { _appType = value; _isAppTypeSet = true; } }
