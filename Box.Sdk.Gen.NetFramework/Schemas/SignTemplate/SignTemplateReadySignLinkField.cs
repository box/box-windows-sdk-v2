...
namespace Box.Sdk.Gen.Schemas {
    public class SignTemplateReadySignLinkField : ISerializable {
        ...
        public string Instructions { get => _instructions; set { _instructions = value; _isInstructionsSet = true; } }
        ...
        public string FolderId { get => _folderId; set { _folderId = value; _isFolderIdSet = true; } }
