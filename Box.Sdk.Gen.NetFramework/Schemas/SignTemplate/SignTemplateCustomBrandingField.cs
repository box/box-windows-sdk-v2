...
namespace Box.Sdk.Gen.Schemas {
    public class SignTemplateCustomBrandingField : ISerializable {
        ...
        public string CompanyName { get => _companyName; set { _companyName = value; _isCompanyNameSet = true; } }

        /// <summary>
        /// Custom branding logo URI in the form of a base64 image.
        /// </summary>
        [JsonPropertyName("logo_uri")]
        public string LogoUri { get => _logoUri; set { _logoUri = value; _isLogoUriSet = true; } }

        /// <summary>
        /// Custom branding color in hex.
        /// </summary>
        [JsonPropertyName("branding_color")]
        public string BrandingColor { get => _brandingColor; set { _brandingColor = value; _isBrandingColorSet = true; } }

        /// <summary>
        /// Content of the email footer.
        /// </summary>
        [JsonPropertyName("email_footer_text")]
        public string EmailFooterText { get => _emailFooterText; set { _emailFooterText = value; _isEmailFooterTextSet = true; } }
