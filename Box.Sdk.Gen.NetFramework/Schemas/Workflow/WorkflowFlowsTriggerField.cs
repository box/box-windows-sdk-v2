...
namespace Box.Sdk.Gen.Schemas {
    public class WorkflowFlowsTriggerField : ISerializable {
        ...
        public StringEnum<WorkflowFlowsTriggerTypeField> Type { get; set; }
        ...
        public StringEnum<WorkflowFlowsTriggerTriggerTypeField> TriggerType { get; set; }

        /// <summary>
        /// List of trigger scopes.
        /// </summary>
        [JsonPropertyName("scope")]
        public IReadOnlyList<WorkflowFlowsTriggerScopeField> Scope { get; set; }
