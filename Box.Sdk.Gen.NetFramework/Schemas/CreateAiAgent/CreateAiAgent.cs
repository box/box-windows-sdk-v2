...
namespace Box.Sdk.Gen.Schemas {
    public class CreateAiAgent : ISerializable {
        ...
        public StringEnum<CreateAiAgentTypeField> Type { get; set; }
        ...
        public IReadOnlyList<AiAgentAllowedEntity> AllowedEntities { get; set; }

        [JsonPropertyName("ask")]
        public AiStudioAgentAsk Ask { get; set; }

        [JsonPropertyName("text_gen")]
        public AiStudioAgentTextGen TextGen { get; set; }

        [JsonPropertyName("extract")]
        public AiStudioAgentExtract Extract { get; set; }
