...
namespace Box.Sdk.Gen.Schemas {
    public class MetadataCascadePolicy : ISerializable {
        ...
        public StringEnum<MetadataCascadePolicyTypeField> Type { get; set; }

        /// <summary>
        /// The enterprise that owns this policy.
        /// </summary>
        [JsonPropertyName("owner_enterprise")]
        public MetadataCascadePolicyOwnerEnterpriseField OwnerEnterprise { get; set; }

        /// <summary>
        /// Represent the folder the policy is applied to.
        /// </summary>
        [JsonPropertyName("parent")]
        public MetadataCascadePolicyParentField Parent { get; set; }
