...
namespace Box.Sdk.Gen.Schemas {
    public class RecentItem : ISerializable {
        ...
        public FileFullOrFolderFullOrWebLink Item { get; set; }
        ...
        public StringEnum<RecentItemInteractionTypeField> InteractionType { get; set; }

        /// <summary>
        /// The time of the most recent interaction.
        /// </summary>
        [JsonPropertyName("interacted_at")]
        public System.DateTimeOffset? InteractedAt { get; set; }
