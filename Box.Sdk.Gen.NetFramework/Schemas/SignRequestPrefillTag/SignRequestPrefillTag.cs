...
namespace Box.Sdk.Gen.Schemas {
    public class SignRequestPrefillTag : ISerializable {
        ...
        protected System.DateTimeOffset? _dateValue { get; set; }

        /// <summary>
        /// This references the ID of a specific tag contained in a file of the signature request.
        /// </summary>
        [JsonPropertyName("document_tag_id")]
        public string DocumentTagId { get => _documentTagId; set { _documentTagId = value; _isDocumentTagIdSet = true; } }

        /// <summary>
        /// Text prefill value.
        /// </summary>
        [JsonPropertyName("text_value")]
        public string TextValue { get => _textValue; set { _textValue = value; _isTextValueSet = true; } }

        /// <summary>
        /// Checkbox prefill value.
        /// </summary>
        [JsonPropertyName("checkbox_value")]
        public bool? CheckboxValue { get => _checkboxValue; set { _checkboxValue = value; _isCheckboxValueSet = true; } }
        ...
        public System.DateTimeOffset? DateValue { get => _dateValue; set { _dateValue = value; _isDateValueSet = true; } }
