...
namespace Box.Sdk.Gen.Schemas {
    public class FileVersion : FileVersionMini, ISerializable {
        ...
        public UserMini TrashedBy { get; set; }

        /// <summary>
        /// When the file version was restored from the trash.
        /// </summary>
        [JsonPropertyName("restored_at")]
        public System.DateTimeOffset? RestoredAt { get => _restoredAt; set { _restoredAt = value; _isRestoredAtSet = true; } }

        [JsonPropertyName("restored_by")]
        public UserMini RestoredBy { get; set; }
