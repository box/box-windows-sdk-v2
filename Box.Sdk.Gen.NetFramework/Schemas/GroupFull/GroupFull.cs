...
namespace Box.Sdk.Gen.Schemas {
    public class GroupFull : Group, ISerializable {
        ...
        public StringEnum<GroupFullInvitabilityLevelField> InvitabilityLevel { get; set; }
        ...
        public StringEnum<GroupFullMemberViewabilityLevelField> MemberViewabilityLevel { get; set; }

        [JsonPropertyName("permissions")]
        public GroupFullPermissionsField Permissions { get; set; }
