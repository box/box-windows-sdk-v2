...
namespace Box.Sdk.Gen.Schemas {
    public class SharedLinkPermissionsV2025R0 : ISerializable {
        ...
        public string SharedLinksOption { get => _sharedLinksOption; set { _sharedLinksOption = value; _isSharedLinksOptionSet = true; } }

        /// <summary>
        /// The default shared link type.
        /// </summary>
        [JsonPropertyName("default_shared_link_type")]
        public string DefaultSharedLinkType { get => _defaultSharedLinkType; set { _defaultSharedLinkType = value; _isDefaultSharedLinkTypeSet = true; } }

        /// <summary>
        /// The selected option for notes shared links permissions.
        /// </summary>
        [JsonPropertyName("notes_shared_link_option")]
        public string NotesSharedLinkOption { get => _notesSharedLinkOption; set { _notesSharedLinkOption = value; _isNotesSharedLinkOptionSet = true; } }

        /// <summary>
        /// The default notes shared link type.
        /// </summary>
        [JsonPropertyName("default_notes_shared_link_type")]
        public string DefaultNotesSharedLinkType { get => _defaultNotesSharedLinkType; set { _defaultNotesSharedLinkType = value; _isDefaultNotesSharedLinkTypeSet = true; } }
