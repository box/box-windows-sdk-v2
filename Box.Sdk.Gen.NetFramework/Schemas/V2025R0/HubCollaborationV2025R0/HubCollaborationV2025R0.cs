...
namespace Box.Sdk.Gen.Schemas {
    public class HubCollaborationV2025R0 : ISerializable {
        ...
        public StringEnum<HubCollaborationV2025R0TypeField> Type { get; set; }

        [JsonPropertyName("hub")]
        public HubBaseV2025R0 Hub { get; set; }

        [JsonPropertyName("accessible_by")]
        public HubAccessGranteeV2025R0 AccessibleBy { get; set; }
        ...
        public StringEnum<HubCollaborationV2025R0StatusField> Status { get; set; }

        [JsonPropertyName("acceptance_requirements_status")]
        public HubCollaborationV2025R0AcceptanceRequirementsStatusField AcceptanceRequirementsStatus { get; set; }
