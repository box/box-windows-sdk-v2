...
namespace Box.Sdk.Gen.Schemas {
    public class DocGenJobV2025R0 : DocGenJobBaseV2025R0, ISerializable {
        ...
        public DocGenBatchBaseV2025R0 Batch { get; set; }

        [JsonPropertyName("template_file")]
        public FileReferenceV2025R0 TemplateFile { get; set; }

        [JsonPropertyName("template_file_version")]
        public FileVersionBaseV2025R0 TemplateFileVersion { get; set; }

        [JsonPropertyName("output_file")]
        public FileReferenceV2025R0 OutputFile { get; set; }

        [JsonPropertyName("output_file_version")]
        public FileVersionBaseV2025R0 OutputFileVersion { get; set; }
        ...
        public StringEnum<DocGenJobV2025R0StatusField> Status { get; set; }
        ...
        public DocGenJobV2025R0FailuresField Failures { get => _failures; set { _failures = value; _isFailuresSet = true; } }
