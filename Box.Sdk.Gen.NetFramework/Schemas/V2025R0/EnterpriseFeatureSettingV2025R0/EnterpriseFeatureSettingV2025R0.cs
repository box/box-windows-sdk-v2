...
namespace Box.Sdk.Gen.Schemas {
    public class EnterpriseFeatureSettingV2025R0 : ISerializable {
        ...
        public EnterpriseFeatureSettingV2025R0FeatureField Feature { get; set; }
        ...
        public bool? CanConfigure { get => _canConfigure; set { _canConfigure = value; _isCanConfigureSet = true; } }

        /// <summary>
        /// Whether the feature is configured.
        /// </summary>
        [JsonPropertyName("is_configured")]
        public bool? IsConfigured { get => _isConfigured; set { _isConfigured = value; _isIsConfiguredSet = true; } }

        /// <summary>
        /// Enterprise feature setting is enabled for only this set of users and groups.
        /// </summary>
        [JsonPropertyName("allowlist")]
        public IReadOnlyList<UserOrGroupReferenceV2025R0> Allowlist { get => _allowlist; set { _allowlist = value; _isAllowlistSet = true; } }

        /// <summary>
        /// Enterprise feature setting is enabled for everyone except this set of users and groups.
        /// </summary>
        [JsonPropertyName("denylist")]
        public IReadOnlyList<UserOrGroupReferenceV2025R0> Denylist { get => _denylist; set { _denylist = value; _isDenylistSet = true; } }
