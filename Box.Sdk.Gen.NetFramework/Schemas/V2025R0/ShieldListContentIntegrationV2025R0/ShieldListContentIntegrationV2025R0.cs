...
namespace Box.Sdk.Gen.Schemas {
    public class ShieldListContentIntegrationV2025R0 : ISerializable {
        ...
        public StringEnum<ShieldListContentIntegrationV2025R0TypeField> Type { get; set; }

        /// <summary>
        /// List of integration.
        /// </summary>
        [JsonPropertyName("integrations")]
        public IReadOnlyList<ShieldListContentIntegrationV2025R0IntegrationsField> Integrations { get; set; }
