...
namespace Box.Sdk.Gen.Schemas {
    public class IntegrationMappingTeams : IntegrationMappingBase, ISerializable {
        ...
        public StringEnum<IntegrationMappingTeamsIntegrationTypeField> IntegrationType { get; set; }
        ...
        public IntegrationMappingPartnerItemTeamsUnion PartnerItem { get; set; }

        [JsonPropertyName("box_item")]
        public FolderReference BoxItem { get; set; }
