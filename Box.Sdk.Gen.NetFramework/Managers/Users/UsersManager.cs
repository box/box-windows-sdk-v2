...
namespace Box.Sdk.Gen.Managers {
    public class UsersManager {
        ...
        /// </param>
        public async System.Threading.Tasks.Task<Users> GetUsersAsync(GetUsersQueryParams queryParams = default, GetUsersHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task<UserFull> CreateUserAsync(CreateUserRequestBody requestBody, CreateUserQueryParams queryParams = default, CreateUserHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task<UserFull> GetUserMeAsync(GetUserMeQueryParams queryParams = default, GetUserMeHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task<UserFull> GetUserByIdAsync(string userId, GetUserByIdQueryParams queryParams = default, GetUserByIdHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
            queryParams = queryParams ?? new GetUserByIdQueryParams();
            headers = headers ?? new GetUserByIdHeaders();
            Dictionary<string, string> queryParamsMap = Utils.PrepareParams(map: new Dictionary<string, string>() { { "fields", StringUtils.ToStringRepresentation(queryParams.Fields) } });
            Dictionary<string, string> headersMap = Utils.PrepareParams(map: DictionaryUtils.MergeDictionaries(new Dictionary<string, string>() {  }, headers.ExtraHeaders));
            FetchResponse response = await this.NetworkSession.NetworkClient.FetchAsync(options: new FetchOptions(url: string.Concat(this.NetworkSession.BaseUrls.BaseUrl, "/2.0/users/", NullableUtils.Unwrap(StringUtils.ToStringRepresentation(userId))), method: "GET", responseFormat: Box.Sdk.Gen.ResponseFormat.Json) { Parameters = queryParamsMap, Headers = headersMap, Auth = this.Auth, NetworkSession = this.NetworkSession, CancellationToken = cancellationToken }).ConfigureAwait(false);
            return SimpleJsonSerializer.Deserialize<UserFull>(NullableUtils.Unwrap(response.Data));
        }
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task<UserFull> UpdateUserByIdAsync(string userId, UpdateUserByIdRequestBody requestBody = default, UpdateUserByIdQueryParams queryParams = default, UpdateUserByIdHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
        ...
        /// Token used for request cancellation.
        /// </param>
        public async System.Threading.Tasks.Task DeleteUserByIdAsync(string userId, DeleteUserByIdQueryParams queryParams = default, DeleteUserByIdHeaders headers = default, System.Threading.CancellationToken cancellationToken = default) {
