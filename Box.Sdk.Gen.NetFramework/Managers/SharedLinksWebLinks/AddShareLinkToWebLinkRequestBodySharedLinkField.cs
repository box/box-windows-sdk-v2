...
namespace Box.Sdk.Gen.Managers {
    public class AddShareLinkToWebLinkRequestBodySharedLinkField : ISerializable {
        [JsonInclude]
        ...
        [JsonConverter(typeof(StringEnumConverter<AddShareLinkToWebLinkRequestBodySharedLinkAccessField>))]
        public StringEnum<AddShareLinkToWebLinkRequestBodySharedLinkAccessField> Access { get; set; }
        ...
        public System.DateTimeOffset? UnsharedAt { get; set; }

        [JsonPropertyName("permissions")]
        public AddShareLinkToWebLinkRequestBodySharedLinkPermissionsField Permissions { get; set; }
