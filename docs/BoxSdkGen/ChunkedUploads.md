...
```
await client.ChunkedUploads.UploadBigFileVersionAsync(fileId: uploadedFile.Id, file: Utils.GenerateByteStream(size: versionFileSize), fileSize: (long)(versionFileSize), fileName: versionName);
```
